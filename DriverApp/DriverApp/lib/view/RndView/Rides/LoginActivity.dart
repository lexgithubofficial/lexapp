...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
      ...
      //***controller****///
    final LoginCantroller controller = Get.put(LoginCantroller());
              ...
              children: [
                ...
                Column(
                  children: [
                    Container(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Center(child: Obx(() {
                          return Text(controller.NAME.toString());
                        },)),
                      ),
                    ),
                    Center(child: Obx(() {
                    ...
                    Text("NOTIFICATION"),
                   Obx(() =>  Switch(value: controller.swichFlag.value, onChanged: (v){
                     controller.changeswichbtn(v);
                     print(v);
                   }))
